...
const SchedulesView: React.FC<SchedulesViewProps> = ({ data, onUpdateData, currentUser, currentCycle }) => {
  ...
  const getTeacherInfo = (teacherId: string) => {
      ...
      const disciplines = Array.from(new Set(teacher.assignments?.map(a => a.subject) || [])).join(' / ');
            ...
            <div className="h-full flex flex-col">
                <div className="mb-6 print:hidden bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-wrap gap-4 items-end">
                    ...
                    <button 
                        ...
                        className="flex items-center gap-2 bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition-colors shadow text-sm font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                    >
             ...
             <div className="h-full flex flex-col max-w-[215mm] mx-auto">
                ...
                {viewGradeGroup ? (
                    <div className="bg-white shadow-lg mx-auto max-w-[215mm] p-[10mm] print:shadow-none print:w-full print:max-w-none">
                        ...
                        <div className="mt-8 text-[9px] text-slate-500">
                            * Los horarios están sujetos a cambios por necesidades del servicio educativo.
                        </div>
                    </div>
                ) : (
                    <div className="flex-1 flex items-center justify-center text-slate-400">
