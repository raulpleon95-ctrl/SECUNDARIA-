...
import { ArrowLeft, Search, Filter, Plus, X, Users, Cpu, Upload, Download, Settings2, FileSpreadsheet, Check, Pencil, AlertCircle, CheckSquare, Square } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          <div className="bg-slate-50 px-6 py-4 border-b border-slate-200 flex justify-between items-center">
            ...
            <span className="px-3 py-1 bg-white border border-slate-200 rounded-full text-xs font-medium text-slate-500">
              {studentsInGroup.length} alumnos
            </span>
          </div>
            ...
            <table className="min-w-full divide-y divide-slate-200">
              <thead className="bg-white">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Tecnología Asignada</th>
                ...
                {filteredStudents.length > 0 ? filteredStudents.map((student) => (
                  ...
                  <tr>
                    <td colSpan={5} className="px-6 py-12 text-center text-slate-400 text-sm">
                      No hay alumnos registrados en el grupo {group}.
                      <br/>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-fade-in-up">
            ...
            <form onSubmit={handleAddStudent} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">Tecnología (Taller)</label>
                <select 
                                        ...
                                        >
                                            ...
                                            {row.map((cell: any, cIdx: number) => {
                                                ...
                                                if (isHeader) {
                                                    ...
                                                    if (cIdx === columnMapping.tech) suffix = ' [TALLER]';
                                                }
